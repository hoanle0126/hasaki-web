...
export const GET_CATEGORIES_CHILDREN_SUCCESS = "GET_CATEGORIES_CHILDREN_SUCCESS";
export const GET_CATEGORIES_CHILDREN_FAILURE = "GET_CATEGORIES_CHILDREN_FAILURE";
